package com.stoicfree.free.redis.module.aop.advice;
...
import com.stoicfree.free.redis.module.aop.RepeatLimit;
import com.stoicfree.free.redis.module.client.RedisClient;
...
public class RepeatLimitAdvice {
    ...
    @Before("@annotation(com.stoicfree.free.redis.module.aop.RepeatLimit)")
    ...
    @After("@annotation(com.stoicfree.free.redis.module.aop.RepeatLimit)")
