...
import com.stoicfree.free.db.module.config.DbProperties;
import com.stoicfree.free.db.module.support.ShardingThreadLocal;
 ...
 */
@Configuration
@ConditionalOnExpression("${free.db.enable:false}")
@EnableConfigurationProperties({DbProperties.class})
public class DbModuleAutoConfiguration {
    @Autowired
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor(TableNameHandler tableNameHandler) {
        ...
        Set<Class<?>> classes = ClassUtil.scanPackageByAnnotation(dbProperties.getEntityPackage(), TableName.class);
