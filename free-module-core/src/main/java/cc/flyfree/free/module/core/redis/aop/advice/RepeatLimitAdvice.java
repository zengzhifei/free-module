package cc.flyfree.free.module.core.redis.aop.advice;
...
import cc.flyfree.free.module.core.redis.aop.RepeatLimit;
...
public class RepeatLimitAdvice {
    ...
    @Before("@annotation(cc.flyfree.free.module.core.redis.aop.RepeatLimit)")
    ...
    @After("@annotation(cc.flyfree.free.module.core.redis.aop.RepeatLimit)")
